    ...
    sidebar: {
      '/guide/': [
        ...
        },
        {
          text: 'Usage',
          items: [
            { text: 'API Examples', link: '/guide/examples' }
          ]
        },
        {
          text: 'Advanced',
      ...
      '/api/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'TenraiClientOptions', link: '/api/interfaces/TenraiClientOptions' }
          ]
        },
        {
          text: 'Endpoints',
          items: [
            ...
            { text: 'CharactersEndpoint', link: '/api/classes/CharactersEndpoint' },
